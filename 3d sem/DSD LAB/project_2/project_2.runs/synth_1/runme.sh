...
HD_PWD='D:/Class/DSD LAB/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_02.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exp_02.tcl
