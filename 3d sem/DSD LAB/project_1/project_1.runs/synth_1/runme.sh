...
HD_PWD='D:/Class/DSD LAB/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_01.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exp_01.tcl
