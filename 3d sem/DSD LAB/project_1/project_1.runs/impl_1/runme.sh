...
HD_PWD='D:/Class/DSD LAB/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_01.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exp_01.tcl -notrace
